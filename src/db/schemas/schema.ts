import { pgTable, serial, varchar, date, timestamp, integer, foreignKey, text, boolean, doublePrecision, check } from "drizzle-orm/pg-core"
...
export const votes = pgTable("votes", {
	...
	return {
		...
		votesRatingCheck: check("votes_rating_check", sql`(rating >= 1) AND (rating <= 10)`),
	}
});
